...
<matplotlib.figure.Figure at 0x7fd304cb6ba8>
In [90]:
# use output of this cell to fill answer field 
...
<matplotlib.figure.Figure at 0x7fd304391e48>
In [94]:
# use output of this cell to fill answer field 
...
<matplotlib.figure.Figure at 0x7fd3360c4240>
In [100]:
# use output of this cell to fill answer field 
...
In [102]:
grader.submit(COURSE EMAILID, COURSERA_TOKEN)
Submitted to Coursera platform. See results on assignment page!
